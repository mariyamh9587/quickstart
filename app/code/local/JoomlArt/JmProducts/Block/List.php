...
//echo $this->_config ['mode'];
		...
		$products = $resource->addAttributeToSelect(Mage::getSingleton('catalog/config')->getProductAttributes())
						...
						->addAttributeToFilter('latest_prod', 1, 'left') //esajee
		...
		}else if($this->_config ['mode'] == "best_buy"){
		...
		//	echo 'its 2';
			...
			$products = $resource->addAttributeToSelect(Mage::getSingleton('catalog/config')->getProductAttributes())
						...
						->addAttributeToFilter('best_selling', 1, 'left') //esajee
...
//		echo $this->_config['catsid'].'-';
//echo $products->getSelect();  // echo query
		return $list;
